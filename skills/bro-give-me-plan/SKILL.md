...
**ОБЯЗАТЕЛЬНО** для каждого шага реализации в файле плана, в вехней части плана в в **frontmatter** части, нужно заполнить парамтер `todos` по шаблону:
```yaml
---
todos:
...
**НЕ НУЖНО** этот блок писать в теле плана, только в **frontmatter**!
