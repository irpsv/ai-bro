...
Перед размещением артефактов **ПРОВЕРЬ** наличие банка. Если `memory-bank/index.md` отсутствует — **СООБЩИ** человеку, что нужна инициализация memory bank, и **ДОЖДИСЬ** решения.
