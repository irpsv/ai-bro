...
* model: [analytics](./references/subagent-model-tiers.md#analytics)

Перед каждым запуском /debugger определи тир и семейство модели по [subagent-model-tiers](./references/subagent-model-tiers.md).
