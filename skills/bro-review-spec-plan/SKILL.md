...
Скилл можно вызвать напрямую или из другого скилла той же сессии. Оркестратор сам артефакт не ревьюит: что считать finding, задают промпты субагентов.
...
2. Полный текст артефакта, переданный вызывающим скиллом.
3. Прикреплённый или открытый файл спецификации или плана.
4. Полный текст артефакта в текущем сообщении человека.
5. Если есть ровно один очевидный свежий кандидат — возьми его и назови путь в отчёте. Если кандидатов несколько или ни одного — не угадывай.

Если объект так и не установлен — остановись и задай один вопрос, что ревьюить. Не начинай ревью по догадке. Если вызывающий скилл уже передал путь или текст — не спрашивай объект заново.
