...
name: bro-do-it
description: >
  Автономно реализует задачу из готового плана или прямо из диалога, проверяет
  результат и проводит обязательное ревью через субагентов. Используй только при
  явном вызове /bro-do-it, когда пользователь поручает выполнить согласованную
  задачу. Не используй для обсуждения решения, составления плана или ревью без
  исправлений.
